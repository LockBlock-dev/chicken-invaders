...
Game::Game()
    : window(sf::RenderWindow(sf::VideoMode({screenWidth, screenHeight}),
                              "Chicken Invaders")),
      uveDX(nullptr), fontsList(nullptr), surfacesAndChainsList(nullptr),
      soundsList(nullptr), isLoaded(false), isPainted(false),
      isInitialized(false), surface_salmonsky(nullptr),
      surface_chain_chickenb(nullptr), surface_chain_chicken_attack(nullptr),
      surface_chain_fighter(nullptr), surface_chain_sparc(nullptr),
      surface_chain_crystal(nullptr), surface_chain_smoke(nullptr),
      surface_chain_missile(nullptr), surface_chain_exhaust(nullptr),
      surface_chain_shield(nullptr), surface_chain_egg(nullptr),
      surface_chain_chicken_leg(nullptr), surface_chain_gift_box(nullptr),
      ...
      surface_chain_feather(nullptr), surface_earth(nullptr),
      surface_heart(nullptr), surface_chain_burger(nullptr),
      surface_chain_talkbubble(nullptr), surface_logo_small(nullptr),
      surface_chain_chicken_boss(nullptr), sound_2001(nullptr),
      sound_space(nullptr), sound_bonewah(nullptr), sound_fanfar1(nullptr),
      sound_fx11(nullptr), sound_fx110(nullptr), sound_rdfx31(nullptr),
      sound_rdfx31_boss(nullptr), sound_tr3_239(nullptr),
      sound_cannonfire(nullptr), sound_fx113(nullptr), sound_chomp(nullptr),
      sound_gpolice_12(nullptr), sound_harley1(nullptr),
      gameController(nullptr), messenger(nullptr),
      // original game uses BGR 0xFFDC00
      color_lightBlue(0x00DCFFFF), color_white(sf::Color::White),
      font_alphabet(nullptr), font_alphabet_small(nullptr), font_3x7(nullptr),
      shouldQuit(false) {
  this->window.setFramerateLimit(targetFPS);
}
...
void Game::init() {
  if (!this->uveDX) {
    this->uveDX = new UveDX::UveDX{false, screenWidth, screenHeight, 16};
...
void Game::paint() {
  ...
  this->font_alphabet_small->blitText(320, 210,
                                      "you can compare yourself against", 6);
  this->font_alphabet_small->blitText(320, 230,
                                      "people from all over the world", 6);
  this->font_alphabet_small->blitText(320, 250, "by uploading your high scores",
                                      6);
  ...
  this->font_alphabet_small->blitText(320, 200, "continue your adventure in",
                                      6);
...
void Game::loadGameResources() {
  ...
  for (unsigned int i = 0; i < 256; ++i) {
    double angle = 1.5705 - i * 6.282 * 0.00390625;

    global::dsin[i] = -std::sin(angle);
    global::dcos[i] = std::cos(angle);
  }
  ...
  this->surface_salmonsky =
      new UveDX::Surface{this->uveDX, "gfx/salmonsky.bmp"};
  ...
  this->surface_chain_chickenb =
      new UveDX::SurfaceChain{this->uveDX, "gfx/chickenb"};
  ...
  this->surface_chain_chicken_attack =
      new UveDX::SurfaceChain{this->uveDX, "gfx/chicken-attack"};
  ...
  this->surface_chain_fighter =
      new UveDX::SurfaceChain{this->uveDX, "gfx/fighter"};
  ...
  this->surface_chain_sparc = new UveDX::SurfaceChain{this->uveDX, "gfx/sparc"};
  ...
  this->surface_chain_crystal =
      new UveDX::SurfaceChain{this->uveDX, "gfx/crystal"};
  ...
  this->surface_chain_smoke = new UveDX::SurfaceChain{this->uveDX, "gfx/smoke"};
  ...
  this->surface_chain_missile =
      new UveDX::SurfaceChain{this->uveDX, "gfx/missile"};
  ...
  this->surface_chain_exhaust =
      new UveDX::SurfaceChain{this->uveDX, "gfx/exhaust"};
  ...
  this->surface_chain_shield =
      new UveDX::SurfaceChain{this->uveDX, "gfx/shield"};
  ...
  this->surface_chain_egg = new UveDX::SurfaceChain{this->uveDX, "gfx/egg"};
  ...
  this->surface_chain_chicken_leg =
      new UveDX::SurfaceChain{this->uveDX, "gfx/chickenleg"};
  ...
  this->surface_chain_gift_box =
      new UveDX::SurfaceChain{this->uveDX, "gfx/giftbox"};
  ...
  this->surface_chain_asteroid_big_rock =
      new UveDX::SurfaceChain{this->uveDX, "gfx/asteroid-big-rock"};
  ...
  this->surface_chain_asteroid_small_rock =
      new UveDX::SurfaceChain{this->uveDX, "gfx/asteroid-small-rock"};
  ...
  this->surface_chain_asteroid_big_fire =
      new UveDX::SurfaceChain{this->uveDX, "gfx/asteroid-big-fire"};
  ...
  this->surface_chain_asteroid_small_fire =
      new UveDX::SurfaceChain{this->uveDX, "gfx/asteroid-small-fire"};
  ...
  this->surface_chain_feather =
      new UveDX::SurfaceChain{this->uveDX, "gfx/feather"};
  ...
  this->surface_earth = new UveDX::Surface{this->uveDX, "gfx/earth_0.bmp"};
  ...
  this->surface_heart = new UveDX::Surface{this->uveDX, "gfx/heart.bmp"};
  ...
  this->surface_chain_burger =
      new UveDX::SurfaceChain{this->uveDX, "gfx/burger"};
  ...
  this->surface_chain_talkbubble =
      new UveDX::SurfaceChain{this->uveDX, "gfx/talkbubble"};
  ...
  this->surface_logo_small =
      new UveDX::Surface{this->uveDX, "gfx/logo-small_0.bmp"};
  ...
  this->surface_chain_chicken_boss =
      new UveDX::SurfaceChain{this->uveDX, "gfx/chicken-boss"};
  ...
  this->sound_2001 = new UveDX::Sound{this->uveDX, "sfx/2001.wav"};
  ...
  this->sound_space = new UveDX::Sound{this->uveDX, "sfx/space.wav"};
  ...
  this->sound_bonewah = new UveDX::Sound{this->uveDX, "sfx/bonewah.wav"};
  ...
  this->sound_fanfar1 = new UveDX::Sound{this->uveDX, "sfx/fanfar1.wav"};
  ...
  this->sound_fx11 = new UveDX::Sound{this->uveDX, "sfx/fx11.wav"};
  ...
  this->sound_fx110 = new UveDX::Sound{this->uveDX, "sfx/fx110.wav"};
  ...
  this->sound_rdfx31 = new UveDX::Sound{this->uveDX, "sfx/rdfx31.wav"};
  ...
  this->sound_rdfx31_boss =
      new UveDX::Sound{this->uveDX, "sfx/rdfx31-boss.wav"};
  ...
  this->sound_tr3_239 = new UveDX::Sound{this->uveDX, "sfx/tr3_239.wav"};
  ...
  this->sound_cannonfire = new UveDX::Sound{this->uveDX, "sfx/cannonfire.wav"};
  ...
  this->sound_fx113 = new UveDX::Sound{this->uveDX, "sfx/fx113.wav"};
  ...
  this->sound_chomp = new UveDX::Sound{this->uveDX, "sfx/chomp.wav"};
  ...
  this->sound_gpolice_12 = new UveDX::Sound{this->uveDX, "sfx/gpolice_12.wav"};
  ...
  this->sound_harley1 = new UveDX::Sound{this->uveDX, "sfx/harley1.wav"};
  ...
  this->font_alphabet = new UveDX::Font{this->uveDX, "gfx/alphabet"};
  ...
  this->font_alphabet_small = new UveDX::Font{this->uveDX, "gfx/alphabet-s"};
...
void Game::playIntro() {
  ...
  this->uveDX->backSurface->blitWithColor();
  this->uveDX->backSurface->loadBMP("gfx/particleflux.bmp", 0xFFFF8000,
                                    0xFFFF8000);
  this->uveDX->frame();
  this->uveDX->waitForEscapeKey(2000);
  ...
  this->uveDX->add(
      new DelayText{this->uveDX, 200, "a long time ago", 100, 120});
  ...
  this->uveDX->add(
      new DelayText{this->uveDX, 200, "chicken invasion", 300, 130});
    ...
    if (++i > 0) {
      ...
      while (true) {
        ...
        if (++j >= 300) {
          ...
          this->uveDX->add(new DelayText(this->uveDX, 200,
                                         "our hero is faced with", 150, 100));

          this->uveDX->add(new DelayText(this->uveDX, 240,
                                         "problems of his own...", 150, 100));
          ...
          while (true) {
            ...
            if (++k >= 230) {
              ...
              this->uveDX->add(
                  new UveDX::Sprite{this->uveDX, 340, 240,
                                    this->surface_chain_burger->getSurf(0)});
              this->uveDX->add(
                  new UveDX::Sprite{this->uveDX, 250, 300,
                                    this->surface_chain_fighter->getSurf(4)});
...
void Game::drawProgressBar(int startX, int startY, unsigned int progressWidth,
                           unsigned int totalWidth, unsigned int barHeight) {
  sf::RectangleShape rect{sf::Vector2f(totalWidth + 4, barHeight + 4)};
  rect.setPosition(sf::Vector2f(startX - 2, startY - 2));
  rect.setFillColor(this->color_lightBlue);

  this->window.draw(rect);

  rect.setSize(sf::Vector2f(rect.getSize().x - 2, rect.getSize().y - 2));
  rect.setPosition(
      sf::Vector2f(rect.getPosition().x + 1, rect.getPosition().y + 1));
  rect.setFillColor(sf::Color::Black);

  this->window.draw(rect);

  rect.setSize(sf::Vector2f(progressWidth, rect.getSize().y - 2));
  rect.setPosition(
      sf::Vector2f(rect.getPosition().x + 1, rect.getPosition().y + 1));
  rect.setFillColor(this->color_white);
